...
#configure nfs
sudo sh -c 'echo "10.0.0.10:/home/ubuntu/sharedata /home/ubuntu/sharedata nfs auto,nofail,noatime,nolock,intr,tcp,actimeo=1800 0 0" >> /etc/fstab'
sudo mount -a
...
#for bbb node only
pip install -r /home/ubuntu/setup_py_node/pip/bbb_requirements.txt
